...
#include "../../myclient/setipdialog.h"
...
void SetIPDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->emitIP((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            typedef void (SetIPDialog::*_t)(QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SetIPDialog::emitIP)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject SetIPDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SetIPDialog.data,
      qt_meta_data_SetIPDialog,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void SetIPDialog::emitIP(QString & _t1)
{
