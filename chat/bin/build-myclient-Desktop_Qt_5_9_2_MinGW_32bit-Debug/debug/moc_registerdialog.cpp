...
#include "../../myclient/registerdialog.h"
...
QT_MOC_LITERAL(1, 15, 10), // "sendregmsg"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 11), // "QByteArray&"
QT_MOC_LITERAL(4, 39, 3), // "arr"
QT_MOC_LITERAL(5, 43, 18), // "on_push_ok_clicked"
QT_MOC_LITERAL(6, 62, 22) // "on_push_cancel_clicked"

    },
    "RegisterDialog\0sendregmsg\0\0QByteArray&\0"
    "arr\0on_push_ok_clicked\0on_push_cancel_clicked"
};
...
void RegisterDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendregmsg((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 1: _t->on_push_ok_clicked(); break;
        case 2: _t->on_push_cancel_clicked(); break;
        default: ;
        }
        ...
        {
            typedef void (RegisterDialog::*_t)(QByteArray & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RegisterDialog::sendregmsg)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RegisterDialog::sendregmsg(QByteArray & _t1)
{
